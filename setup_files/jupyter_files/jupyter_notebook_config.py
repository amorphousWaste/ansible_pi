...
## Allow to be changed at login for the notebook server.
#
...
#  Default: ''
c.NotebookApp.certfile = u'/home/pi/.jupyter/jupytercert.pem'
...
#  Default: ''
c.NotebookApp.keyfile = u'/home/pi/.jupyter/jupytercert.key'
...
#  Default: ''
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$T1mTwNGxiqBWZApXuC9kAA$5l5w91Q3KIzMaQp32IPPmw'
...
#  Choices: any of ['sha512', 'sha384', 'sha1', 'blake2s', 'sha3_512', 'sha3_224', 'sha3_384', 'sha224', 'md5', 'sha256', 'blake2b', 'sha3_256']
#  Default: 'sha256'
